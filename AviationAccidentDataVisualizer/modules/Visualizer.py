...
def map_by_states(df):
    ...
    user_select = user_query_input("From:[TotalFatalInjuries, TotalSeriousInjuries, TotalMinorInjuries, TotalUninjured, TotalAccidentNumber]", 
...
def time_ranged_heat_map(df):
    ...
    user_select = user_query_input("From:[TotalFatalInjuries, TotalSeriousInjuries, TotalMinorInjuries, TotalUninjured]", 
...
def bar_plot(df):
        user_xlabel = user_query_input("Enter One X-axis Element: ['AirportCode', 'AircraftCategory', 'Model', 'Make','BroadPhaseOfFlight']", 
...
def pie_plot(df):
    user_xlabel = user_query_input("Enter One Element: ['AirportCode', 'AircraftCategory', 'Model', 'Make','BroadPhaseOfFlight']", 
                ['AirportCode', 'AircraftCategory', 'Model', 'Make','BroadPhaseOfFlight'])
